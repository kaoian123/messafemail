    ...
    <div class="container">
        <div class="row">
            <div class="col-md alert alert-info ">
                <div>
                    <h1 class="mb-4 text-primary">註冊畫面</h1>
                </div>
                <form action='../src/Contorllers/Account/Create.php' method='post'>
                    ...
                    <button type="submit" class=" float-right btn btn-info mt-3">註冊</button>
                </form>
                <div class="mt-3">
                    <a href="./SingnIn.php">
                        放棄註冊
